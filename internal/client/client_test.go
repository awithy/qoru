...
func TestMultipleStreamsOnOneQUICConnection(t *testing.T) {
	...
	streamA, err := OpenTCPStream(ctx, conn, "018ff6f2-5c7b-7d4a-b7f1-9c0e6e7a0001", "echo-a", "", nil)
	if err != nil {
		t.Fatalf("open stream A: %v", err)
	}
	streamB, err := OpenTCPStream(ctx, conn, "018ff6f2-5c7b-7d4a-b7f1-9c0e6e7a0002", "echo-b", "", nil)
	if err != nil {
...
func TestOpenTCPStreamReturnsTargetDialError(t *testing.T) {
	...
	_, err = OpenTCPStream(ctx, conn, "018ff6f2-5c7b-7d4a-b7f1-9c0e6e7a1234", "echo", "", nil)
	if err == nil {
...
func TestOpenTCPStreamReturnsEgressError(t *testing.T) {
	...
	_, err = OpenTCPStream(ctx, conn, "018ff6f2-5c7b-7d4a-b7f1-9c0e6e7a1234", "echo", "server-2", nil)
	if err == nil {
...
func TestOpenTCPStreamProxiesBytesToTarget(t *testing.T) {
	...
	stream, err := OpenTCPStream(ctx, conn, "018ff6f2-5c7b-7d4a-b7f1-9c0e6e7a1234", "echo", "", nil)
	if err != nil {
